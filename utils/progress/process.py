...
from utils.tools.ffmpeg import screenshot_from_video
...
#mediainfo/bdinfo解析
def process_media_directory(torrent_path, file_dir, pic_num, username, password, chinese_title, english_title, year, season, media, codec, audiocodec, maker, tmdb_id, imdb_id, mal_id, tvdb_id, media_type,  child, internal, personal, keywords, upload_title,passkey):
    ...
    if file_name:
        ...
        if action == "mediainfo":
            ...
            if resolution and video_format and audio_format:
                ...
                pic_urls = screenshot_from_video(largest_video_file,folder_path,pic_num)
            else:
            ...
            sys.exit()
        kimoji_upload(torrent_path, file_name, username, password, chinese_title, english_title, year, season, media, codec, audiocodec, maker ,pic_urls, tmdb_id, imdb_id, mal_id, tvdb_id, media_type, child, resolution, bd_info, internal,personal,keywords,upload_title, mediainfo_output,passkey)
    else:
